...
def PostMyTopic(request):
    if request.method == 'POST':
        ...
        filename = fs.save('C:/Users/mahen/OneDrive/Desktop/MedicalSocial/User/static/post/'+str(count)+'.png', myfile)
...
def Signup(request):
    if request.method == 'POST':
      ...
      fs = FileSystemStorage()
      filename = fs.save('C:/Users/mahen/OneDrive/Desktop/MedicalSocial/User/static/profiles/'+username+'.png', myfile)
...
def EditMyProfile(request):
    if request.method == 'POST':
      ...
      if os.path.exists('C:/Users/mahen/OneDrive/Desktop/MedicalSocial/User/static/profiles/'+username+'.png'):
          os.remove('C:/Users/mahen/OneDrive/Desktop/MedicalSocial/User/static/profiles/'+username+'.png')
